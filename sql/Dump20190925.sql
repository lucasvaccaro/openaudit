...
--
-- Table structure for table `report_securitygroups`
--

DROP TABLE IF EXISTS `report_securitygroups`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `report_securitygroups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `snapshot_id` int(11) DEFAULT NULL,
  `port_id` varchar(36) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_report_securitygroups_1_idx` (`snapshot_id`),
  CONSTRAINT `fk_report_securitygroups_1` FOREIGN KEY (`snapshot_id`) REFERENCES `snapshots` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2019-09-25 21:15:45
